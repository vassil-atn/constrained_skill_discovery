...
class SkillsCfg:
    ...
    pose_command = mdp.UniformPose2dCommandCfg(
        ...
        ranges=mdp.UniformPose2dCommandCfg.Ranges(
            pos_x=(-10.0, 10.0), pos_y=(-10.0, 10.0), heading=(0.0, 0.0)
        ),
...
class ObservationsCfg:
    ...
    class SkillConditioningCfg(ObsGroup):
        selected_skills = ObsTerm(
            func=mdp.generated_commands, params={"command_name": "skills"}, scale=0.0
        )
...
class RewardsCfg:
    ...
    # dof_vel_limits = RewTerm(func=mdp.joint_vel_limits,params={"soft_ratio" : 1.0}, weight=-1.)
    ...
    # position_tracking_rudin = RewTerm(
    #     func=mdp.position_command_rudin,
    #     weight=1000.,
    #     params={"reward_duration_s": 2.0, "command_name": "pose_command", "asset_cfg": SceneEntityCfg("robot", body_names="base")},
    # )
    vel_to_target = RewTerm(
    ...
    energy = RewTerm(func=mdp.energy_reward, weight=-1e-5)
...
@configclass
class AnymalDRewardDenseEnvCfg(ManagerBasedRLEnvCfg):
...
@configclass
class AnymalDRewardDenseEnvCfg_PLAY(AnymalDRewardDenseEnvCfg):
