...
env = load_isaacgym_env_preview4(task_name="Anymal",headless=True,num_envs=4096)
env = wrap_env(env)
...
# cfg_trainer = {"timesteps": 24000, "headless": True}
# trainer = SequentialTrainer(cfg=cfg_trainer, env=env, agents=agent)
# path = "runs/torch/Anymal/24-01-16_15-30-47-740478_PPO/checkpoints/agent_12000.pt"
# agent.load(path)
# # # start evaluation
# trainer.eval()
