...
class PPO(Agent):
    ...
    def act(self, states: torch.Tensor, timestep: int, timesteps: int) -> torch.Tensor:
        ...
        actions, log_prob, outputs, _ = self.policy.act({"states": self._state_preprocessor(states)}, role="policy")
    ...
    def _update(self, timestep: int, timesteps: int) -> None:
        ...
        for epoch in range(self._learning_epochs):
            ...
            for sampled_states, sampled_actions, sampled_log_prob, sampled_values, sampled_returns, sampled_advantages in sampled_batches:
                ...
                _, next_log_prob, _, _ = self.policy.act({"states": sampled_states, "taken_actions": sampled_actions}, role="policy")
