...
It renames all the occurrences of constrained_skill_discovery (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "constrained_skill_discovery"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the constrained_skill_discovery folder
        os.rename(
            os.path.join(root_dir_path, "exts", "constrained_skill_discovery", "constrained_skill_discovery"),
            os.path.join(root_dir_path, "exts", "constrained_skill_discovery", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "constrained_skill_discovery"), os.path.join(root_dir_path, "exts", new_name))
